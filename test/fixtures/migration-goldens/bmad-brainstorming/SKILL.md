...
artifacts:
  ...
  - path: assets/brain-methods.csv
    source: assets/brain-methods.csv
    kind: scaffold-verbatim
  - path: assets/brain-icons.json
    source: assets/brain-icons.json
    kind: scaffold-verbatim
  - path: assets/brain-selector.html
    source: assets/brain-selector.html
    kind: scaffold-verbatim
  - path: references/converge.md
    source: references/converge.md
    kind: scaffold-verbatim
  - path: references/finalize.md
    source: references/finalize.md
    kind: scaffold-verbatim
  - path: references/headless.md
    source: references/headless.md
    kind: scaffold-verbatim
  - path: references/in-chat-techniques.md
    source: references/in-chat-techniques.md
    kind: scaffold-verbatim
  - path: references/mode-autonomous.md
    source: references/mode-autonomous.md
    kind: scaffold-verbatim
  - path: references/mode-facilitator.md
    source: references/mode-facilitator.md
    kind: scaffold-verbatim
  - path: references/mode-partner.md
    source: references/mode-partner.md
    kind: scaffold-verbatim
  - path: references/resume.md
    source: references/resume.md
    kind: scaffold-verbatim
  - path: scripts/brain.py
    source: scripts/brain.py
    kind: scaffold-verbatim
  - path: scripts/memlog.py
    source: scripts/memlog.py
    kind: scaffold-verbatim
  - path: scripts/tests/test_brain.py
    source: scripts/tests/test_brain.py
    kind: scaffold-verbatim
  - path: scripts/tests/test_memlog.py
    source: scripts/tests/test_memlog.py
    kind: scaffold-verbatim
  - path: analysis/catalog-analysis.md
    source: analysis/catalog-analysis.md
    kind: scaffold-verbatim
  - path: analysis/method-matrix.csv
    source: analysis/method-matrix.csv
    kind: scaffold-verbatim
---
