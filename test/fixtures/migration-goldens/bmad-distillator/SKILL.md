...
artifacts:
  - path: agents/distillate-compressor.md
    source: agents/distillate-compressor.md
    kind: scaffold-verbatim
  - path: agents/round-trip-reconstructor.md
    source: agents/round-trip-reconstructor.md
    kind: scaffold-verbatim
  - path: resources/compression-rules.md
    source: resources/compression-rules.md
    kind: scaffold-verbatim
  - path: resources/distillate-format-reference.md
    source: resources/distillate-format-reference.md
    kind: scaffold-verbatim
  - path: resources/splitting-strategy.md
    source: resources/splitting-strategy.md
    kind: scaffold-verbatim
  - path: scripts/analyze_sources.py
    source: scripts/analyze_sources.py
    kind: scaffold-verbatim
  - path: scripts/tests/test_analyze_sources.py
    source: scripts/tests/test_analyze_sources.py
    kind: scaffold-verbatim
---
