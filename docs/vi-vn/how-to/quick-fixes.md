...
Sử dụng **Build** cho sửa lỗi, refactor, hoặc các thay đổi nhỏ có mục tiêu rõ ràng mà không cần quy trình BMad Method đầy đủ.
...
Xem [Build](../explanation/build.md) để hiểu rõ hơn Build nằm ở đâu trong BMad Method.
