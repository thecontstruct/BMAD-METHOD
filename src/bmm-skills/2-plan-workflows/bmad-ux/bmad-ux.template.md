...
artifacts:
  - path: assets/color-themes.md
    source: assets/color-themes.md
    kind: scaffold-verbatim
  - path: assets/design-directions.md
    source: assets/design-directions.md
    kind: scaffold-verbatim
  - path: assets/design-example-editorial.md
    source: assets/design-example-editorial.md
    kind: scaffold-verbatim
  - path: assets/design-example-mobile.md
    source: assets/design-example-mobile.md
    kind: scaffold-verbatim
  - path: assets/design-example-shadcn.md
    source: assets/design-example-shadcn.md
    kind: scaffold-verbatim
  - path: assets/excalidraw-wireframe.md
    source: assets/excalidraw-wireframe.md
    kind: scaffold-verbatim
  - path: assets/experience-example-mobile.md
    source: assets/experience-example-mobile.md
    kind: scaffold-verbatim
  - path: assets/experience-example-shadcn.md
    source: assets/experience-example-shadcn.md
    kind: scaffold-verbatim
  - path: assets/headless-schemas.md
    source: assets/headless-schemas.md
    kind: scaffold-verbatim
  - path: assets/key-screens.md
    source: assets/key-screens.md
    kind: scaffold-verbatim
  - path: assets/validation-report-template.html
    source: assets/validation-report-template.html
    kind: scaffold-verbatim
  - path: references/creative-tools.md
    source: references/creative-tools.md
    kind: scaffold-verbatim
  - path: references/design-md-spec.md
    source: references/design-md-spec.md
    kind: scaffold-verbatim
