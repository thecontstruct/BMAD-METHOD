...
artifacts:
  ...
  - path: technical-steps/step-01-init.md
    source: technical-steps/step-01-init.md
    kind: scaffold-verbatim
  - path: technical-steps/step-02-technical-overview.md
    source: technical-steps/step-02-technical-overview.md
    kind: scaffold-verbatim
  - path: technical-steps/step-03-integration-patterns.md
    source: technical-steps/step-03-integration-patterns.md
    kind: scaffold-verbatim
  - path: technical-steps/step-04-architectural-patterns.md
    source: technical-steps/step-04-architectural-patterns.md
    kind: scaffold-verbatim
  - path: technical-steps/step-05-implementation-research.md
    source: technical-steps/step-05-implementation-research.md
    kind: scaffold-verbatim
  - path: technical-steps/step-06-research-synthesis.md
    source: technical-steps/step-06-research-synthesis.md
    kind: scaffold-verbatim
---
