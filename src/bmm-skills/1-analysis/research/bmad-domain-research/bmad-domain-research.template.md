...
artifacts:
  ...
  - path: domain-steps/step-01-init.md
    source: domain-steps/step-01-init.md
    kind: scaffold-verbatim
  - path: domain-steps/step-02-domain-analysis.md
    source: domain-steps/step-02-domain-analysis.md
    kind: scaffold-verbatim
  - path: domain-steps/step-03-competitive-landscape.md
    source: domain-steps/step-03-competitive-landscape.md
    kind: scaffold-verbatim
  - path: domain-steps/step-04-regulatory-focus.md
    source: domain-steps/step-04-regulatory-focus.md
    kind: scaffold-verbatim
  - path: domain-steps/step-05-technical-trends.md
    source: domain-steps/step-05-technical-trends.md
    kind: scaffold-verbatim
  - path: domain-steps/step-06-research-synthesis.md
    source: domain-steps/step-06-research-synthesis.md
    kind: scaffold-verbatim
---
