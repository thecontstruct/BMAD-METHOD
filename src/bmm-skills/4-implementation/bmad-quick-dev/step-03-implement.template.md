...
<<include path="_shared/fragments/sub-agent-activation.template.md" spawn_action="Hand `{spec_file}` to a subagent/task and let it implement." fallback_action="implement directly.">>
