...
artifacts:
  ...
  - path: assets/spine-template.md
    source: assets/spine-template.md
    kind: scaffold-verbatim
  - path: references/headless.md
    source: references/headless.md
    kind: scaffold-verbatim
  - path: references/reviewer-gate.md
    source: references/reviewer-gate.md
    kind: scaffold-verbatim
  - path: scripts/lint_spine.py
    source: scripts/lint_spine.py
    kind: scaffold-verbatim
  - path: scripts/tests/test_lint_spine.py
    source: scripts/tests/test_lint_spine.py
    kind: scaffold-verbatim
---
# BMad Architecture
