...
artifacts:
  ...
  - path: references/create-party.md
    source: references/create-party.md
    kind: scaffold-verbatim
  - path: references/mode-agent-team.md
    source: references/mode-agent-team.md
    kind: scaffold-verbatim
  - path: references/mode-auto.md
    source: references/mode-auto.md
    kind: scaffold-verbatim
  - path: references/mode-subagent.md
    source: references/mode-subagent.md
    kind: scaffold-verbatim
  - path: references/party-memory.md
    source: references/party-memory.md
    kind: scaffold-verbatim
  - path: scripts/resolve_party.py
    source: scripts/resolve_party.py
    kind: scaffold-verbatim
  - path: scripts/tests/test-resolve_party.py
    source: scripts/tests/test-resolve_party.py
    kind: scaffold-verbatim
---
